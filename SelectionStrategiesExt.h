#ifndef __ANFI_SELECTIONSTRATEGIES_H
#define __ANFI_SELECTIONSTRATEGIES_H
 ...
 * Uses Round Robin selection, but skips any module that is not available currently.
 */
class WheightedRoundRobinSelectionStrategy : public SelectionStrategy
{
    protected:
        int lastIndex; // the index of the module last time used
    public:
        WheightedRoundRobinSelectionStrategy(cSimpleModule *module, bool selectOnInGate);
        virtual int select() override;
};
